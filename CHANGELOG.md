...
- Registrato come gap professionale separato **Account e sicurezza**: la UI corrente non espone ancora una superficie dedicata per password, fattori MFA e logout. Il lavoro è tracciato nell'issue #347 e non viene mescolato con la closure V6.3.3 o con le Impostazioni professionali.
