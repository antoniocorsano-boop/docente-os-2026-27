...
import { isVerifiedMfaFactor } from '@/core/security/account-security-policy'
...
export default async function AccountPage({ searchParams }: AccountPageProps) {
  ...
  const factorsAvailable = !factorsResult.error
  const assuranceAvailable = !assuranceResult.error
  const mfaStateAvailable = factorsAvailable && assuranceAvailable
  ...
  const notice = params.password === 'updated'
    ...
    : params.sessions === 'revoked'
      ? 'Le altre sessioni non potranno più essere rinnovate.'
