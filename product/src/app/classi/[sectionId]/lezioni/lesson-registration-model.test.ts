...
function occurrence(id: string, startAt: string): ProjectedOccurrence {
  return {
    logicalId: id,
...
test('quick registration selects the latest started unrecorded occurrence for the section', () => {
