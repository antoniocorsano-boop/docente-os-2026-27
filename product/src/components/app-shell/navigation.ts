...
export const PRIMARY_NAVIGATION: readonly NavigationItem[] = [
  ...
  },
  {
    ...
    keywords: ['planner', 'attività', 'scadenze', 'oggi'],
  },
  {
    key: 'design',
    href: '/progetta',
  ...
  },
  {
    ...
    label: 'Orario',
    shortLabel: 'Orario',
    description: 'Settimana, lezioni e disponibilità.',
    keywords: ['orario', 'lezioni', 'settimana', 'ore'],
  },
  {
    key: 'annual-plan',
    href: '/piano-annuale',
    label: 'Piano annuale',
    shortLabel: 'Piano',
    description: 'Copertura annuale e avanzamento per classe.',
    keywords: ['piano annuale', 'blocchi', 'programma', 'copertura'],
  },
  {
    key: 'settings',
    href: '/impostazioni',
