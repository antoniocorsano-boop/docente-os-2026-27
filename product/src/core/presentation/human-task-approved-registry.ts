...
const ALL_APPROVED_MANIFESTS = [
  ...APPROVED_HUMAN_TASK_MANIFESTS,
  ...APPROVED_HUMAN_TASK_MANIFESTS_B31_B33,
] as const

const MANIFEST_PROJECTIONS = materializeApprovedHumanTaskManifests(ALL_APPROVED_MANIFESTS)
...
export const APPROVED_HUMAN_TASK_SUPPORT_PACK_BINDINGS = new Map<string, readonly string[]>([
  ...
  ...ALL_APPROVED_MANIFESTS.map((manifest) => [
